...
VALUES
(1, '111.722.333-44', 'Janaina Vesruska', 'Barão do Abíai, 100 - centro', '83996667788', 'Ultrassom'),
(2, '222.353.444-55', 'Bruno Cesar Almeida', 'Av. Floriano Peixoto, 980 - Centro', '83997778899', 'Hemograma'),
(3, '333.434.555-66', 'Camila Torres Lima', 'Rua Rio Grande do Norte, 210 - Liberdade', '83998889900', 'Ressonância Magnética'),
(4, '444.545.666-77', 'Diego Araujo Santos', 'Rua Santa Catarina, 88 - Cruzeiro', '83990001122', 'Tomografia'),
(5, '555.606.777-88', 'Elaine Rodrigues Pacheco', 'Rua Maranhão, 150 - Catolé', '83991122334', 'Eletrocardiograma'),
(6, '666.700.888-99', 'Felipe Gonçalves Ribeiro', 'Rua Sergipe, 300 - Conceição', '83992233445', 'Raio-X'),
(7, '777.828.999-00', 'Gabriela Farias Melo', 'Rua Amazonas, 55 - Prata', '83993344556', 'Endoscopia'),
(8, '888.919.000-11', 'Henrique Batista Cunha', 'Rua Paraíba, 410 - Centro', '83994455667', 'Hemograma'),
(9, '999.070.111-22', 'Isabela Nogueira Freitas', 'Rua Bahia, 72 - Bodocongó', '83995566778', 'Ultrassom'),
(10, '000.191.222-33', 'João Lucas Monteiro', 'Rua Alagoas, 95 - Malvinas', '83996677889', 'Tomografia');
